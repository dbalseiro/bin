...
string WARNING_COLOR = "[0;36m"; // cyan
string DEBUG_COLOR = "[0;32m"; // green
string ERROR_COLOR = "[0;31m"; // red
string INTRO_COLOR = "[0;37m"; // white
string OTHER_COLOR = "[0;33m"; // yellow
string EXITING_COLOR = "[0;40;35m"; // purple
string NUCLEUS_COLOR = "[0;40;35m"; // purple
string ORIGINAL_COLOR = "[0m"; // purple
string INFO_COLOR = ORIGINAL_COLOR; //"[1;32m"; // green
...
{
	printf("\n");
	setTextColor(EXITING_COLOR);
	printf("Ctrl + C detected\n");
	printf("Exiting now...\n");
	setTextColor(ORIGINAL_COLOR);
...
void processLine(string line)
{
	...
	switch (lineType)
	{
		...
		case WARNING_LINE:
			...
			break;
		case DEBUG_LINE:
			setTextColor(DEBUG_COLOR);
			break;
		case ERROR_LINE:
			setTextColor(ERROR_COLOR);
			break;
		case NUCLEUS_LINE:
			setTextColor(NUCLEUS_COLOR);
			break;
		case OTHER_LINE:
			setTextColor(OTHER_COLOR);
			break;
	}
...
int main(int argc, char* argv[])
{
	...
	setTextColor(OTHER_COLOR);
	printf("Colorizer");
	setTextColor(INTRO_COLOR);
	printf(" v");
	printf("%s", RELEASE_NUMBER.c_str());
